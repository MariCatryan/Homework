//Ունեք սովորական String փոփոխական, որի մեջ անգլերեն տառերով տեքստա
//գրած պրոբելներով։։ Դուք պիտի գրեք մեթոդ, որը կստանաս տվյալ String-ը
...
//անի String-ի վրա, String-ի ստանդարտ մեթոդներից կարաք օգտագործեք
//իտերացիա անելու համար անհրաժեշտները՝ String-ի երկարությունը վերցնելու
